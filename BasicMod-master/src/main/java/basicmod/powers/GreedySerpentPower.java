...
public class GreedySerpentPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public GreedySerpentPower(AbstractCreature owner, int amount) {
        ...
        this.region128 = new TextureAtlas.AtlasRegion(
                ImageMaster.loadImage("basicmod/images/powers/large/GreedySerpentCard.png"), 0, 0, 84, 84
        );
        this.region48 = new TextureAtlas.AtlasRegion(
                ImageMaster.loadImage("basicmod/images/powers/GreedySerpentCard.png"), 0, 0, 32, 32
        );
        updateDescription();
    }
